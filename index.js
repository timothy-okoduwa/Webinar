...
var countDownDate = new Date("september 15, 2024 17:00:00").getTime();
...
var x = setInterval(function() {
  ...
  document.getElementById("demo").innerHTML =  '<img src="./Assets/images/alarm.png" alt="">' +`     `+`   ` +`    `+days + "d " + hours + "h "
  + minutes + "m " + seconds + "s ";
